...
def render_combined_frontal_views(
    ...
    """
    Render ALL selected frontalized faces together from fixed views, similar to the
    standalone OBJ renderer: front / left / right / top / iso + multi_view_grid.
    """
    mkdir(out_dir)
...
def run_pipeline(args: argparse.Namespace) -> None:
    ...
    if args.render_frontal and args.render_combined_views and len(combined_ver_dense_lst) > 0:
        combined_dir = out_dir / "renders_combined_frontal"
        combined_frontal_written = render_combined_frontal_views(
        ...
        print(f"Saved combined multi-view frontal renders: {combined_dir}")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="Also render all selected frontalized faces together from fixed views.",
    )
    parser.add_argument(
